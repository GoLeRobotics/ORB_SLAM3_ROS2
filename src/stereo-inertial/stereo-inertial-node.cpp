    ...
    SLAM_(SLAM)
{
    ...
    subImu_ = this->create_subscription<ImuMsg>("/camera/imu", 1000, std::bind(&StereoInertialNode::GrabImu, this, _1));
    subImgLeft_ = this->create_subscription<ImageMsg>("/camera/color/image_raw", 100, std::bind(&StereoInertialNode::GrabImageLeft, this, _1));
    subImgRight_ = this->create_subscription<ImageMsg>("/camera/depth/image_rect_raw", 100, std::bind(&StereoInertialNode::GrabImageRight, this, _1));
